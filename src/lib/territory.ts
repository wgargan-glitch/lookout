...
export const TERRITORIES: Territory[] = [
  ...
  },
  {
    ...
    shortLabel: "Europe",
    published: false,
    kicker: "Keys in the village beside the park",
    headline: "A local car. At the trailhead.",
    ...
    parksIntro:
      "Europe’s parks are national in name only: France, Spain, Norway, the UK and the rest each designate their own. Lookout maps the drive-to parks — IUCN-style national parks plus the lived-in UK landscapes — with a gateway town for the keys.",
    heroImage: "/images/territories/europe/isles.jpg",
    heroAlt: "A Highland loch and a single-track road toward the park",
    emptyCars: "Hosts near these parks are still listing. If you live in a gateway town, you can list yours.",
    hostCta: "List a car in a gateway town",
    es: {
      name: "Europa",
      shortLabel: "Europa",
      kicker: "Llaves en el pueblo junto al parque",
      headline: "Un auto local. En el sendero.",
      ...
      parksIntro:
        "Los parques de Europa son nacionales solo de nombre: Francia, España, Noruega, el Reino Unido y el resto designan los suyos. Lookout mapea los de acceso por carretera, con un pueblo para las llaves.",
      heroAlt: "Un loch de las Highlands y un camino de un solo carril hacia el parque",
      emptyCars: "Los anfitriones cerca de estos parques todavía se están sumando. Si vives en un pueblo de acceso, puedes publicar el tuyo.",
  ...
  },
  {
    ...
    shortLabel: "LatAm",
    published: false,
    kicker: "From Baja to Patagonia",
    headline: "A local car. At the trailhead.",
    intro: "Leave the motorhome in Creel, El Calafate, Puerto Natales, Quepos. Take a car that already knows the washboard.",
    parksIntro:
      "No single park service from Mexico to Tierra del Fuego. Lookout maps the drive-to parks — Baja, the Andes, the Brazilian chapadas, Patagonia — with a gateway town for the keys.",
    ...
    es: {
      ...
      parksIntro:
        "No hay un solo servicio de parques de México a Tierra del Fuego. Lookout mapea los de acceso por carretera — Baja, los Andes, las chapadas de Brasil, la Patagonia — con un pueblo para las llaves.",
  ...
  },
  {
    ...
    parksIntro:
      "Parks Canada is its own map. Lookout lists the drive-to parks with a town for keys — the Rockies, both coasts, the prairies.",
    ...
    es: {
      ...
      parksIntro:
        "Parks Canada es otro mapa. Lookout lista los parques de acceso por carretera con un pueblo para las llaves: las Rocosas, ambas costas, las praderas.",
  ...
  },
  {
    ...
    shortLabel: "Aus & NZ",
    published: false,
    kicker: "Leave the van on the pad",
    headline: "A local car. At the trailhead.",
    ...
    parksIntro:
      "Australia and New Zealand are the other great motorhome countries. Lookout maps the drive-to parks — the red centre, both islands, Tasmania — with a town for keys.",
    ...
    es: {
      ...
      parksIntro:
        "Australia y Nueva Zelanda son los otros grandes países de motorhome. Lookout mapea los parques de acceso por carretera — el centro rojo, ambas islas, Tasmania — con un pueblo para las llaves.",
  ...
  },
  {
    ...
    shortLabel: "S. Africa",
    published: false,
    kicker: "On the self-drive loop",
    headline: "A local car. At the trailhead.",
    intro: "Kruger, Sossusvlei, Chobe, the Garden Route. Leave the camper at camp. Take a car that already knows a gravel park road.",
    parksIntro:
      "Southern Africa is a self-drive circuit, not one park service. Lookout maps Kruger to the Cape, Namibia, Botswana, and the Falls — with a gateway town for the keys.",
    ...
    es: {
      ...
      parksIntro:
        "El sur de África es un circuito self-drive, no un solo servicio de parques. Lookout mapea de Kruger al Cabo, Namibia, Botsuana y las Cataratas — con un pueblo para las llaves.",
