...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    topic: "hosts",
    body: [
      "You need an account with a phone number. List from List a car — paste the VIN, or photograph the dash plate, door sticker, or registration, to fill year, make, model, drivetrain, fuel, and doors from the factory record. A license plate still goes on the listing so guests know the car. Then park, pickup notes, insurance, and the photo gallery.",
